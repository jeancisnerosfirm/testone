...
class DisputesDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return datatables()
            ...
            ->editColumn('claimant_id', function ($dispute) {
                $claimant = (isset($dispute->claimant->first_name) && !empty($dispute->claimant->first_name)) ? $dispute->claimant->first_name . ' ' . $dispute->claimant->last_name : "-";
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn(['data' => 'claimant_id', 'name' => 'claimant.last_name', 'title' => 'Claimant', 'visible' => false])
            ->addColumn(['data' => 'claimant_id', 'name' => 'claimant.first_name', 'title' => 'Claimant'])
            ->addColumn(['data' => 'defendant_id', 'name' => 'defendant.last_name', 'title' => 'Defendant', 'visible' => false])
            ->addColumn(['data' => 'defendant_id', 'name' => 'defendant.first_name', 'title' => 'Defendant'])
