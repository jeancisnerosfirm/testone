    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('user_id', function ($documentVerification) {
                if (isset($documentVerification->user->id) && !empty($documentVerification->user->id)) {
                    $sender = $documentVerification->user->first_name . ' ' . $documentVerification->user->last_name;
