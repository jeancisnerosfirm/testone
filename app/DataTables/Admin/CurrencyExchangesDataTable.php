...
class CurrencyExchangesDataTable extends DataTable
{
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function ($exchange) {
                return (Common::has_permission(Auth::guard('admin')->user()->id, 'edit_exchange')) ? '<a href="' . url(Config::get('adminPrefix') . '/exchange/edit/' . $exchange->id) . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;' : '';
            })
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn(['data' => 'fc_code', 'name' => 'fc_code', 'title' => 'From'])

            ->addColumn(['data' => 'tc_code', 'name' => 'tc_code', 'title' => 'To'])
