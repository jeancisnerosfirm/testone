...
class RevenueController extends Controller
{
    public function revenues_list(RevenuesDataTable $dataTable)
    {
        ...
        ->whereIn('transaction_type_id', [Deposit, Withdrawal, Exchange_From, Transferred, Request_To, Payment_Received])->groupBy('currency_id')->select('currency_id')->get();
        ...
        ->where('status', 'Success')
        ->whereIn('transaction_type_id', [Deposit, Withdrawal, Exchange_From, Transferred, Request_To, Payment_Received])->groupBy('transaction_type_id')->select('transaction_type_id')->get();
