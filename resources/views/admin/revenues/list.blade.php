...
@section('page_content')
                  ...
                  <div class="col-md-3">
                     <div class="panel panel-primary">
                          <div class="panel-body text-center" style="padding:5px; margin-bottom: 0;">
                            <span class="text-info" style="font-size: 15px">Total {{ $currencyCode }} Revenue</span>
                            <strong><h4>{{ moneyFormat($currencyCode , formatNumber($currency['revenue'], $currency['currency_id'])) }}</h4></strong>
                          </div>
                     </div>
                  </div>
                @endif
  ...
  <div class="row">
      <div class="col-md-8">
          <h3 class="panel-title text-bold ml-5">All Revenues</h3>
      </div>
      <div class="col-md-4">
