...
<div class="my-30">
    <div class="row">
        <form action="{{ url(\Config::get('adminPrefix').'/deposits/update') }}" class="form-horizontal" id="deposit_form" method="POST">
            {{ csrf_field() }}
            <!-- Page title start -->
                                ...
                                <div class="mt-4 p-4 bg-secondary rounded shadow">
                                    ...
                                    @if ($deposit->payment_method)
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <p class="form-control-static">{{ ($deposit->payment_method->name == "Mts") ? settings('name') : $deposit->payment_method->name }}</p>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if (config('mobilemoney.is_active') && $deposit->mobilemoney)
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <p class="form-control-static">{{ $deposit->mobilemoney->mobilemoney_name ?? '' }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <p class="form-control-static">{{ $deposit->mobilemoney->mobilemoney_number ?? '' }}</p>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-2"><a id="cancel_anchor" class="btn btn-theme-danger pull-left" href="{{ url(\Config::get('adminPrefix').'/deposits') }}">Cancel</a></div>
                                            <div class="col-md-4">
                                ...
                                <div class="mt-4 p-4 bg-secondary rounded shadow">
                                    @if ($deposit->amount)
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <p class="form-control-static">{{  moneyFormat($deposit->currency->symbol, formatNumber($deposit->amount, $deposit->currency->id)) }}</p>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group total-deposit-feesTotal-space">
                                        ...
                                        <div class="col-sm-6">
                                        <p class="form-control-static">{{  moneyFormat($deposit->currency->symbol, formatNumber($feesTotal, $deposit->currency->id)) }}</p>
                                        </div>
                                    </div>
                                    ...
                                    @if (isset($total))
                                        <div class="form-group total-deposit-space">
                                            ...
                                            <div class="col-sm-6">
                                            <p class="form-control-static">{{  moneyFormat($deposit->currency->symbol, formatNumber($total, $deposit->currency->id)) }}</p>
                                            </div>
                                        </div>
                                    @endif
                                </div>
