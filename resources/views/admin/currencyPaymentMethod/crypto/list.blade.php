...
@section('page_content')
    ...
    <div class="box">
        <div class="box-body">
            <div class="dropdown">
                <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">Currency : <span
        ...
        <div class="col-md-9">
            <div class="box box-info">
                <div class="box-header with-border text-center">
                    <h3 class="box-title">{{ ucfirst($list_menu) }} Settings</h3>
                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control processing_time" name="processing_time" type="text"
                                        placeholder="CoinPayments Processing Time"
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" class="btn btn-theme pull-right" id="paymentMethodList_update">
                                    <i class="fa fa-spinner fa-spin" style="display: none;"></i> <span
                                        id="paymentMethodList_update_text">Update</span>
                                </button>
                            </div>
