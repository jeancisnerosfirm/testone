...
@section('page_content')
    <div class="box">
        <div class="box-body pb-20">
            <form class="form-horizontal" action="{{ url(\Config::get('adminPrefix').'/transactions') }}" method="GET" id='transaction_form'>
    ...
    $(document).ready(function()
    {
        ...
        $('#user_input').autocomplete(
        {
            source:function(req,res)
            {
                ...
                {
                    $.ajax({
                        url:'{{url(\Config::get('adminPrefix').'/transactions_user_search')}}',
                        dataType:'json',
                        type:'get',
                        data:{
                            search:req.term
