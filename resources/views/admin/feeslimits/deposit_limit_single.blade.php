	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="box box-info">
				...
				<form action='{{url(\Config::get('adminPrefix').'/settings/feeslimit/update-deposit-limit')}}' class="form-horizontal" method="POST" id="deposit_limit_form">
					{!! csrf_field() !!}
					...
					<div class="box-body">
						...
						<div class="form-group">
								...
								<div class="col-sm-5">
								<input class="form-control min_limit" name="min_limit" type="text" value="{{ isset($feeslimit->min_limit) ? number_format((float)$feeslimit->min_limit, $preference, '.', '') : number_format((float)1.00000000, $preference, '.', '') }}" id="min_limit" onkeypress="return isNumberOrDecimalPointKey(this, event);"
								...
								<div class="col-sm-4">
								<p>If not set, minimum limit is {{ number_format((float)1.00000000, $preference, '.', '') }}</p>
								</div>
						</div>
						<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<p>If not set, charge percentage is {{ number_format((float)0.00000000, $preference, '.', '') }}</p>
							</div>
						</div>
						<div class="clearfix"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<p>If not set, charge fixed is {{ number_format((float)0.00000000, $preference, '.', '') }}</p>
							</div>
						</div>
						<div class="clearfix"></div>
					</div>
					...
					<div class="box-footer">
						<a href="{{  url(\Config::get('adminPrefix')."/settings/currency") }}" class="btn btn-theme-danger">Cancel</a>
