        ...
        <div class="box-body">
            ...
            <div class="row">
                    ...
                    <div class="dropdown pull-left" style="margin-top: 10px;">
                        ...
                        <ul class="dropdown-menu">
                            @foreach ($currencyList as $currencyItem)
                                <li class="listItem" data-type="{{ $currencyItem->type }}"  data-rel="{{ $currencyItem->id }}"
                ...
                <div class="col-md-2 col-md-offset-8 defaultCurrencyDiv" style="display: none;">
                    <h4 class="form-control-static pull-right"><span class="label label-success">Default Currency</span>
                    </h4>
                </div>
            </div>
        </div>
                ...
                <form action='{{ url(\Config::get('adminPrefix') . '/settings/feeslimit/update-deposit-limit') }}'
                                        ...
                                        <div id="collapse{{ $method->id }}" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label default_currency_label"
                                                        for="has_transaction">Is Activated</label>
                                                    <div class="col-sm-5">
                                                        <label class="checkbox-container">
                                                            <input type="checkbox" class="has_transaction"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        ...
                                                        <small
                                                            class="form-text text-muted"><strong>{{ allowedDecimalPlaceMessage($preference) }}</strong></small>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <p>If not set, minimum limit is
                                                            {{ number_format((float) 1.0, $preference, '.', '') }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                ...
                                                <!-- Maximum Limit -->
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="max_limit">Maximum
                                                        Limit</label>
                                                    <div class="col-sm-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input class="form-control charge_percentage"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <p>If not set, charge percentage is
                                                            {{ number_format((float) 0.0, $preference, '.', '') }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                ...
                                                <!-- Charge Fixed -->
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="charge_fixed">Charge
                                                        Fixed</label>
                                                    <div class="col-sm-5">
                                                        <input class="form-control charge_fixed" name="charge_fixed[]"
                                                            type="text"
                    ...
                    <div class="box-footer">
                        <a href="{{ url(\Config::get('adminPrefix') . '/settings/currency') }}"
                            class="btn btn-theme-danger">Cancel</a>
                        <button type="submit" class="btn btn-theme pull-right" id="deposit_limit_update">
                            <i class="fa fa-spinner fa-spin" style="display: none;"></i> <span
                                id="deposit_limit_update_text">Update</span>
                        </button>
                    </div>
                </form>
