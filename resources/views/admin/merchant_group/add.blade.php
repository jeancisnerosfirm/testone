  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        ...
        <!-- form start -->
        <form method="POST" action="{{ url(\Config::get('adminPrefix').'/settings/add-merchant-group') }}" class="form-horizontal" enctype="multipart/form-data" id="merchant-group-add-form">
          {{ csrf_field() }}
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="fee" class="form-control" value="{{ old('fee') }}" placeholder="Add fee" id="fee" onkeypress="return isNumberOrDecimalPointKey(this, event);" oninput="restrictNumberToPrefdecimalOnInput(this)">
                @if($errors->has('fee'))
                  <span class="error">
          ...
          <div class="box-footer">
            <a class="btn btn-theme-danger" href="{{ url(\Config::get('adminPrefix').'/settings/merchant-group') }}">Cancel</a>
            <button type="submit" class="btn btn-theme pull-right">&nbsp; Add &nbsp;</button>
          </div>
        </form>
      </div>
    </div>
