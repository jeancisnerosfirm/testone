    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="box box-info">
                ...
                <!-- form start -->
                <form method="POST" action="{{ url(\Config::get('adminPrefix').'/settings/edit-merchant-group/'. $merchantGroup->id) }}" class="form-horizontal" id="merchant-group-edit-form">
                    {{ csrf_field() }}
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="fee" class="form-control" value="{{ number_format((float)$merchantGroup->fee, preference('decimal_format_amount')) }}" placeholder="Edit fee" id="fee" onkeypress="return isNumberOrDecimalPointKey(this, event);" oninput="restrictNumberToPrefdecimalOnInput(this)">
                                @if($errors->has('fee'))
                                    <span class="help-block">
