...
<div class="box box-default">
	<div class="box-body">
		<div class="d-flex justify-content-between">
			<div>
				<div class="top-bar-title padding-bottom pull-left">Dispute</div>
			</div>
		...
		<div class="box-body">
			<form action="{{url(\Config::get('adminPrefix').'/dispute/reply')}}" id="reply" method="post" enctype="multipart/form-data">
				...
				<div class="form-group col-sm-12 text-right">
					<button type="submit" class="btn btn-theme" id="dispute-reply"><i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="dispute-reply-text">Submit</span></button>
				</div>
...
<script type="text/javascript">
	...
	$('#reply').validate({
        ...
        submitHandler: function(form)
        {
            ...
            $(".fa-spin").show();
            $("#dispute-reply-text").text('Submitting...');
            form.submit();
        }
	});
	...
	$("#status").on('change', function()
	{
		...
		$.ajax({
			method: "POST",
			url: SITE_URL+"/"+ADMIN_PREFIX+"/dispute/change_reply_status",
