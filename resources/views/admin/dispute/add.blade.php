...
<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <form method="POST" action="{{url(\Config::get('adminPrefix').'/dispute/open')}}" class="form-horizontal" id="dispute_add_form" accept-charset='UTF-8'>
                ...
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a id="cancel_anchor" href="{{  url(\Config::get('adminPrefix')."/disputes") }}" class="btn btn-danger btn-flat">Cancel</a>
                        <button type="submit" class="btn btn-primary btn-flat pull-right" id="submit">
                            <i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="dispute_add_text">Submit</span>
                        </button>
                    </div>
                </div>
            </form>
