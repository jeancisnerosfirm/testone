...
<div class="row">
    <div class="col-md-10">
        <h3 class="pull-left panel-title text-bold ml-5">{{ $merchant->business_name }}</h3>
    </div>
    <div class="col-md-2">
        @if ($merchant->status)
            <h3 class="pull-right  panel-title text-bold">@if ($merchant->status == 'Approved')<span class="text-green">Approved</span>@endif
                                    ...
                                    @if ($merchant_payments)
                                        @foreach($merchant_payments as $merchant_payment)
                                            <tr>
                                                ...
                                                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_merchant_payment'))
                                                <td>
                                                    <a class="btn btn-xs btn-primary" href="{{url(\Config::get('adminPrefix').'/merchant_payments/edit/'.$merchant_payment->id)}}"><i class="glyphicon glyphicon-edit"></i></a>
                                                </td>
                                                @endif
