...
@section('page_content')
	<div class="box">
		<div class="panel-body ml-20">
			<ul class="nav nav-tabs cus" role="tablist">
				<li class="active">
				<a href='{{ url(\Config::get('adminPrefix')."/merchant/edit/$merchant->id")}}'>Profile</a>
				</li>

				<li>
				<a href="{{ url(\Config::get('adminPrefix')."/merchant/payments/$merchant->id")}}">Payments</a>
				</li>
			</ul>
	...
	<div class="row">
		<div class="col-md-10">
			<h3 class="ml-5 panel-title text-bold pull-left">{{ $merchant->business_name }}</h3>
		</div>
		<div class="col-md-2">
			@if ($merchant->status)
				<h3 class="panel-title pull-right">@if ($merchant->status == 'Approved')<span class="text-green">Approved</span>@endif
				@if ($merchant->status == 'Moderation')<span class="text-blue">Moderation</span>@endif
				@if ($merchant->status == 'Disapproved')<span class="text-red">Disapproved</span>@endif</h3>
			@endif
		</div>
	</div>
	...
	<div class="box mt-20">
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						<form action="{{ url(\Config::get('adminPrefix').'/merchant/update') }}" class="form-horizontal" id="merchant_edit_form" method="POST" enctype="multipart/form-data">
							{{ csrf_field() }}
							...
							<div class="col-md-7">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" name="fee" onkeypress="return isNumberOrDecimalPointKey(this, event);"
										placeholder=""
							...
							<div class="row">
								<div class="col-md-11">
									...
									<div class="col-md-2"><a id="cancel_anchor" class="btn btn-theme-danger pull-left" href="{{ url(\Config::get('adminPrefix').'/merchants') }}">Cancel</a></div>
									<div class="col-md-1">
										<button type="submit" class="btn btn-theme pull-right" id="merchant_edit">
