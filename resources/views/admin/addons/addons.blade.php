                    ...
                    <form action="{{ url(\Config::get('adminPrefix').'/custom/addons') }}" class="form-horizontal" method="POST" id="AddonUploadForm" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" placeholder="Enter addon purchase code" name="purchase_code" value="{{ old('purchase_code') }}" type="text" id="purchase_code" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" placeholder="Enter your envato username" name="envato_user_name" value="{{ old('envato_user_name') }}" type="text" id="envato_user_name" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button type="submit" class="btn btn-theme pull-right" id="addon-upload-submit-btn"><i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="addon-upload-submit-btn-text">{{ __('Upload') }}</span></button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="box box-info">
            <div class="row">
                <div class="col-md-12">
                    <img src="{{ url('public/images/addon/' . $addon->image) }}" class="setting-img" alt="Addon Image" style="border-top-left-radius: 5px;border-top-right-radius: 5px;">
                </div>
            </div>
