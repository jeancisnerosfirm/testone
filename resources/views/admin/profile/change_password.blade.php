            ...
            <form action='{{  url(\Config::get('adminPrefix')."/change-password") }}' method="POST" class="form-horizontal" id="password_form" >
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label" for="old_pass">{{ __('Current password') }}</label>
                  <div class="col-sm-7">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label" for="password">{{ __('New password') }}</label>
                  <div class="col-sm-7">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label" for="new_pass_confirmation">{{ __('Confirm new password') }}</label>
                  <div class="col-sm-7">
              ...
              <div class="box-footer">
                <a class="btn btn-danger btn-flat pull-left" href="{{ url(\Config::get('adminPrefix').'/profile') }}">Cancel</a>
