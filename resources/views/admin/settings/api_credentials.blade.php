                ...
                <form action="{{ url(\Config::get('adminPrefix').'/settings/api_informations') }}" method="post" class="form-horizontal" id="api-credentials" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="captcha_site_key" class="form-control" value="{{ $recaptcha['site_key'] ?? '' }}" placeholder="captcha site key">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="captcha_secret_key" class="form-control" value="{{ $recaptcha['secret_key'] ?? '' }}" placeholder="captcha secret key">
