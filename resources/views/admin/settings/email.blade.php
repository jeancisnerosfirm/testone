                    ...
                    <div class="box-body">
                        ...
                        <div id="smtpFields" @if($result['email_protocol']=="smtp") style="display: block;" @else style="display: none;" @endif>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="from_address" class="form-control" value="{{ isset($result['from_address']) ? $result['from_address'] : '' }}" placeholder="From Address (ex - example@mail.com)" id="from_address">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="from_name" class="form-control" value="{{ isset($result['from_name']) ? $result['from_name'] : '' }}" placeholder="From Name (ex - Paymoney)" id="from_name">
