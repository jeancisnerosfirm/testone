...
@section('page_content')
    <div class="box box-default">
        <div class="box-body">
            <div class="d-flex justify-content-between">
                <div>
                    <div class="top-bar-title padding-bottom pull-left">Request Payment Details</div>
                </div>

                <div>
                    @if ($request_payments->status)
                        <h4 class="text-left">Status : @if ($request_payments->status == 'Success')<span class="text-green">Success</span>
                            @endif
                            @if ($request_payments->status == 'Pending')<span
                                class="text-blue">Pending</span>
                            @endif
                            @if ($request_payments->status == 'Refund')<span
                                class="text-warning">Refunded</span>
                            @endif
                            @if ($request_payments->status == 'Blocked')<span
                                class="text-red">Cancelled</span>
                            @endif
                        </h4>
                    @endif
                </div>
    ...
    <section class="min-vh-100">
        <div class="my-30">
            <div class="row">
                <form action="{{ url(\Config::get('adminPrefix') . '/request_payments/update') }}" class="form-horizontal"
                    method="POST">
                    {{ csrf_field() }}
                    <!-- Page title start -->
                                        ...
                                        <div class="mt-4 p-4 bg-secondary rounded shadow">
                                            ...
                                            @if ($request_payments->user)
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3" for="user">Request
                                                        From</label>
                                                    <input type="hidden" class="form-control" name="user"
                                                        value="{{ isset($request_payments->user) ? $request_payments->user->first_name . ' ' . $request_payments->user->last_name : '-' }}">
                                                    <div class="col-sm-9">
                                                        <p class="form-control-static">
                                                            {{ isset($request_payments->user) ? $request_payments->user->first_name . ' ' . $request_payments->user->last_name : '-' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            @if ($request_payments->receiver)
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3" for="receiver">Request
                                                        To</label>
                                                    <input type="hidden" class="form-control" name="receiver"
                                                        value="{{ isset($request_payments->receiver) ? $request_payments->receiver->first_name . ' ' . $request_payments->receiver->last_name : '-' }}">
                                                    <div class="col-sm-9">
                                                        <p class="form-control-static">
                                                            {{ isset($request_payments->receiver) ? $request_payments->receiver->first_name . ' ' . $request_payments->receiver->last_name : '-' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            @if ($request_payments->uuid)
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3"
                                                        for="request_payments_uuid">Transaction ID</label>
                                            ...
                                            @if ($request_payments->email)
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3"
                                                        for="request_payments_email">Email</label>
                                                    <input type="hidden" class="form-control"
                                            ...
                                            @if ($request_payments->currency)
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" name="currency"
                                                        value="{{ $request_payments->currency->code }}">
                                                    <div class="col-sm-9">
                                                        <p class="form-control-static">
                                                            {{ $request_payments->currency->code }}</p>
                                                    </div>
                                                </div>
                                            @endif
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        @if (isset($transactionOfRefunded) && isset($requestPaymentsOfRefunded))
                                                            <p class="form-control-static"><span
                                                                    class="label label-success">Already
                                                                    Refunded</span></p>

                                                            <p class="form-control-static"><span
                                                                    class="label label-danger">Refund Reference: <i>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2"><a id="cancel_anchor"
                                                                ...
                                                                href="{{ url(\Config::get('adminPrefix') . '/request_payments') }}">Cancel</a>
                                                        </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <button type="submit" class="btn btn-theme pull-right"
                                                                    ...
                                                                    <i class="fa fa-spinner fa-spin"
                                                                        ...
                                                                        id="request_payment_text">Update</span>
                                                                </button>
                                                            </div>
                                                        @endif
                                                    </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="mt-4 p-4 bg-secondary rounded shadow">
                                            ...
                                            @if ($request_payments->amount)
                                                <div class="form-group">
                                                    <label class="control-label col-sm-6" for="amount">Requested
                                                        Amount</label>
                                            ...
                                            <div class="form-group total-deposit-feesTotal-space">
                                                <label class="control-label col-sm-6" for="accept_amount">Accepted
                                                    Amount</label>
                                                <input type="hidden" class="form-control" name="accept_amount"
