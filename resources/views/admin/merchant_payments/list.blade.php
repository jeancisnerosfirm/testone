...
@section('page_content')
    <div class="box">
        <div class="box-body pb-20">
            <form class="form-horizontal" action="{{ url(\Config::get('adminPrefix').'/merchant_payments') }}" method="GET">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex flex-wrap justify-content-between">
                            <div class="d-flex flex-wrap">
                                ...
                                <!-- Payment Method -->
                                <div class="pr-25">
                                    <label for="status">Payment Method</label><br>
    ...
    <div class="row">
        <div class="col-md-8">
            <h3 class="panel-title text-bold ml-5">All Merchant Payments</h3>
        </div>
        <div class="col-md-4">
