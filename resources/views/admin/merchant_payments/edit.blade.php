...
@section('page_content')
    <div class="box box-default">
        <div class="box-body">
            <div class="d-flex justify-content-between">
                <div>
                    <div class="top-bar-title padding-bottom pull-left">Edit Merchant Payment</div>
                </div>

                <div>
                    @if ($merchant_payment->status)
                        <h4 class="text-left">Status : @if ($merchant_payment->status == 'Success')<span class="text-green">Success</span>
                            @endif
                            @if ($merchant_payment->status == 'Pending')<span
                                    class="text-blue">Pending</span>@endif
                            @if ($merchant_payment->status == 'Refund')<span
                                    class="text-red">Refunded</span>@endif
                        </h4>
                    @endif
                </div>
            </div>
    ...
    <section class="min-vh-100">
        <div class="my-30">
            <div class="row">
                <form action="{{ url(\Config::get('adminPrefix') . '/merchant_payments/update') }}" class="form-horizontal"
                                    ...
                                    <div class="panel-body">
                                        <div class="mt-4 p-4 bg-secondary rounded shadow">
                                            ...
                                            @if ($merchant_payment->merchant_id)
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3"
                                                        for="merchant_user">Merchant</label>
                                                    <input type="hidden" name="merchant_user"
                                                        value="{{ $merchant_payment->merchant->user->first_name . ' ' . $merchant_payment->merchant->user->last_name }}">
                                                    <div class="col-sm-9">
                                            ...
                                            @if ($merchant_payment->merchant->type)
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3" for="type">Merchant
                                                        Type</label>
                                                    <div class="col-sm-9">
                                                        <p class="form-control-static">
                                            ...
                                            @if ($merchant_payment->user_id)
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" name="user"
                                                        value="{{ isset($merchant_payment->user) ? $merchant_payment->user->first_name . ' ' . $merchant_payment->user->last_name : '-' }}">
                                                    <div class="col-sm-9">
                                                        <p class="form-control-static">
                                                            {{ isset($merchant_payment->user) ? $merchant_payment->user->first_name . ' ' . $merchant_payment->user->last_name : '-' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            @if ($merchant_payment->uuid)
                                                <div class="form-group">
                                                    <label class="control-label col-sm-3" for="mp_uuid">Transaction
                                                        ID</label>
                                            ...
                                            @if ($merchant_payment->payment_method)
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" name="payment_method"
                                                        value="{{ $merchant_payment->payment_method->name == 'Mts' ? settings('name') : $merchant_payment->payment_method->name }}">
                                                    <div class="col-sm-9">
                                                        <p class="form-control-static">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2"><a id="cancel_anchor"
                                                                ...
                                                                href="{{ url(\Config::get('adminPrefix') . '/merchant_payments') }}">Cancel</a>
                                                        </div>
                                                        ...
                                                        @if (!isset($transactionOfRefunded->refund_reference))
                                                            <div class="col-md-4">
                                                                <button type="submit" class="btn btn-theme pull-right"
                                                                    ...
                                                                    <span id="merchant_payment_edit_text">Update</span>
                                                                </button>
                                                            </div>
                                                        @endif
                                                    </div>
                                        ...
                                        <div class="mt-4 p-4 bg-secondary rounded shadow">
                                            ...
                                            @if ($merchant_payment->amount)
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <p class="form-control-static">
                                                            {{ moneyFormat($merchant_payment->currency->symbol, formatNumber($merchant_payment->amount)) }}
                                                        </p>
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div class="form-group total-deposit-feesTotal-space">
                                                ...
                                                <div class="col-sm-6">
                                                    <p class="form-control-static">
                                                        {{ moneyFormat($merchant_payment->currency->symbol, formatNumber($feesTotal)) }}
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            @if (isset($total))
                                                <div class="form-group total-deposit-space">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <p class="form-control-static">
                                                            {{ moneyFormat($merchant_payment->currency->symbol, formatNumber($total)) }}
                                                        </p>
                                                    </div>
                                                </div>
                                            @endif
