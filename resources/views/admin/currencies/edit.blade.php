                ...
                <form action="{{ url(\Config::get('adminPrefix') . '/settings/edit_currency/' . $currency->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data" id="edit_currency_form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="name" class="form-control" value="{{ $currency->name }}" placeholder="Name" id="name">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="code" class="form-control" value="{{ $currency->code }}" placeholder="Code" id="code">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="symbol" class="form-control" value="{{ $currency->symbol }}" placeholder="Symbol" id="symbol">
                        ...
                        <div class="form-group" id="address_div">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="address" class="form-control" value="{{ $currency->address }}" placeholder="Currency crypto address" id="address">
                        ...
                        <div class="form-group" id="exchange_rate_div">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="rate" class="form-control" value="{{ (float) $currency->rate }}" placeholder="Rate" id="rate" onkeypress="return isNumberOrDecimalPointKey(this, event);" oninput="restrictNumberToPrefdecimalOnInput(this)">
                                <span class="text-danger">{{ $errors->first('rate') }}</span>
                                <div class="clearfix"></div>
                                <small class="form-text text-muted"><strong>{{ __('*Allowed upto 8 decimal places.') }}</strong></small>
                            </div>
                        </div>
                        <!-- Logo -->
                        <div class="form-group">
                            <label for="logo" class="col-sm-3 control-label">{{ __('Logo') }}</label>
                            <div class="col-sm-6">
                                <input type="file" name="logo" class="form-control input-file-field" data-rel="{{ isset($currency->logo) ? $currency->logo : '' }}" id="logo" value="{{ isset($currency->logo) ? $currency->logo : '' }}">
                        ...
                        <div class="form-group" id="allowed_wallet_creation_div">
                            <label class="col-sm-3 control-label" for="create_wallet">{{ __('Create Wallet') }}</label>
                            <div class="col-sm-6">
                                <input type="checkbox" data-toggle="toggle" name="create_wallet" id="create_wallet">
                                <div class="clearfix"></div>
                                <small class="form-text text-muted"><strong>{{ __('*If On, ') }}<span class="network-name"></span> {{ __('wallet will be created for all registered users.') }}</strong></small>
                            </div>
                        </div>
                        <!-- Exchange From -->
                        <div class="form-group" id="exchange_from_div">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control exchange_from" name="exchange_from" id="exchange_from">
                                    <option value='local' {{ isset($currency->exchange_from) && $currency->exchange_from == 'local' ? 'selected' : '' }}>Local</option>
                                    <option value='api' {{ isset($currency->exchange_from) && $currency->exchange_from == 'api' ? 'selected' : '' }}>API</option>
                                </select>
                                <small class="rate-setup-text text-muted" role='button' style="display:none;"><strong><span style="color: red;">{{ __('Setup Currency Converter') }}</span> <a href=""data-toggle="modal" data-target="#currency-converter">Click here.</a></strong></small>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                @if ($currency->default == 1)
                                    <p class="form-control-static"><span class="label label-danger">{{ __('Staus Change Disallowed') }}</span></p>
                                    <p><span class="label label-warning">{{ __('Default Currency') }}</span></p>
                                @else
