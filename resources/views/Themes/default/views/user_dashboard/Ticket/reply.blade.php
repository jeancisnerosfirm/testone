                ...
                <div class="col-md-8 col-xs-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{url('ticket/reply_store')}}" id="reply" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="left">
                                        ...
                                        <div class="profile-id-pic left">
                                            @if(!empty($ticket->user->picture) && file_exists(public_path('user_dashboard/profile/' . $ticket->user->picture)))
                                                <img src="{{ url('public/user_dashboard/profile/' . $ticket->user->picture) }}" class="rounded-circle" style="width:60px;">
                                            @else
                                    ...
                                    <div class="">
                                        <div class="reply-views">
                                            ...
                                            <div class="reply-details">
                                                ...
                                                @if($result->file)
                                                    <div class="mt-3">
                                                        <a class="text-info" href="{{ url('public/uploads/ticketFile/' . $result->file->filename) }}"><i class="fa fa-download"></i> {{ $result->file->originalname }}
                                                        </a>
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="reply-box">
                                                <div class="left">
                                                    <div class="profile-id-pic left">
                                                        ...
                                                        @else
                                                            <img src="{{ url('public/user_dashboard/images/avatar.jpg') }}" alt="Admin Image" class="rounded-circle" style="width:60px;">
                                                        @endif
                                                    </div>
                                                    <div class="left">
