                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="row">
                                                ...
                                                <div class="pr-4">
                                                    @if(!empty(Auth::user()->picture))
                                                        <img src="{{ url('public/user_dashboard/profile/'.Auth::user()->picture) }}"
                                                            ...
                                                            id="profileImage">
                                                    @else
                                                        <img src="{{ theme_asset('public/images/profile/profile.png') }}"
                                                            class="rounded-circle rounded-circle-custom-trans"
                                                            id="profileImage">
                                                    @endif
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="uploadAvatar text-center text-md-right">
                                                <a href="javascript:changeProfile()" id="changePicture"
                                                   class="btn btn-grad w-180p text-left btn-border btn-sm mt-2">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="text-center text-md-right">
                                                <button type="button" class="btn btn-grad text-left w-180p mt-2 btn-text-wrap" data-toggle="modal"
                                                        data-target="#myModal">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-5 mb-2">
                                                                    <div class="row justify-content-center">
                                                                        <div>
                                                                            <button type="submit" class="btn btn-grad">@lang('message.dashboard.button.submit')</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    @if (empty($user->phone))
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="uploadAvatar text-center text-md-right">
                                                    <button type="button" class="btn btn-grad w-180p text-left btn-border btn-sm add" data-toggle="modal" data-target="#add" style="margin-top: 10px;">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <button type="button" class="btn btn-sm btn-grad edit" style="display: none;"><i class="fa fa-edit"></i></button>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-2">
                                                                        <div class="row justify-content-center">
                                                                            <div>
                                                                                <button type="button" class="btn btn-grad next" id="common_button">@lang('message.dashboard.button.next')</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    @else
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="uploadAvatar text-center text-md-right">
                                                    <button type="button" class="btn btn-grad w-180p text-left btn-border btn-sm editModal btn-text-wrap" data-toggle="modal" data-target="#editModal" style="margin-top: 10px;">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body editModalBody">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <button type="button" class="btn btn-sm btn-grad edit_button_edit" style="display: none;"><i class="fa fa-edit"></i></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <button type="button" class="btn btn-grad" data-dismiss="modal" id="close">@lang('message.form.cancel')</button>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            @if ($bothDisabled || $checkPhoneVerification == "Disabled")
                                                                                <button type="button" class="btn btn-grad edit_form_submit" id="common_button_update">@lang('message.form.update')</button>
                                                                            @else
                                                                                <button type="button" class="btn btn-grad update" id="common_button_update">@lang('message.dashboard.button.next')</button>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="col-xl-6">
                                    @if (empty($user->phone))
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="user-profile-qr-code w-200p">
                                                </div>
                                            </div>

                                            <div class="col-lg-6">
                                                <div class="text-center text-lg-right">
                                                    <button type="button" class="btn btn-grad mt-4 w-180p" id="qr-code-btn">
                                                    </button>
                                                    <br>

                                                    <a href="#" class="btn btn-grad mt-3 w-180p mr-auto" id="print-qr-code-btn" style="display: none;">
                                                        <strong>
                                                            {{ __('Print QR Code') }}
                                                        </strong>
                                                    </a>
                                    ...
                                    <div class="row mt-4 mt-lg-0">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="text-center text-lg-right">
                                                <button type="button" class="btn btn-grad w-180p btn-border btn-sm mt-4 update-qr-code btn-text-wrap" id="qr-code-btn">
                                                    @lang('message.dashboard.button.update-qr-code')
                                                </button>
                                                <br>
                                                <a href="#" class="btn btn-grad w-180p btn-border btn-sm mt-3 mr-auto btn-text-wrap" id="print-qr-code-btn" style="display: none;">
                                                    <strong>
                                                        {{ __('Print QR Code') }}
                                                    </strong>
                                                </a>
                            ...
                            <div class="row mt-5 pl-3 pr-3">
                                <div class="col-md-12">
                                    <h3>@lang('message.dashboard.setting.profile-information')</h3>
                                        ...
                                        <form method="post" action="{{url('prifile/update')}}" id="profile_update_form">
                                            ...
                                            <div class="row mt-4">
                                                <div class="form-group col-md-12">
                                                    <button type="submit" class="btn btn-grad col-12" id="users_profile">
...
<script>
    ...
    $(window).on('load', function()
    {
        ...
        if (QrCodeSecret != '') {
            ...
            $(".user-profile-qr-code").html(`<img class="img-responsive" src="${SITE_URL}/public/uploads/userPic/default-image.png" />`);
        ...
        */
        $(document).ready(function()
        {
            $("#edit_phone").intlTelInput({
                ...
                utilsScript: "public/js/intl-tel-input-13.0.0/build/js/utils.js"
            })
            .done(function()
            {
