                ...
                <tr>
                    <td>
                        <table style="margin-top:20px;">
                            ...
                            <tr>
                                <td style="font-size:15px; color:#4e5c6e; line-height:22px;">{{ optional($transaction->merchant)->business_name }}</td>
                            </tr>
                            <br><br>
                            <tr>
                        ...
                        <table style="margin-top:20px; width:300px;">
                            ...
                            <tr style="padding-bottom:10px;">
                                ...
                                <td style="font-size:15px; color:#4e5c6e; text-align:right;">
                                    {{ moneyFormat(optional($transaction->currency)->symbol, formatNumber($transaction->charge_percentage+$transaction->charge_fixed, $transaction->currency_id)) }}
                                </td>
                            </tr>
                            @endif
                            <tr>
                            ...
                            <tr>
                                <td style="font-size:15px; color:#000000; font-weight:bold;">@lang('message.dashboard.left-table.total')</td>
                                <td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">{{ moneyFormat($transaction->currency->symbol, formatNumber($transaction->total, $transaction->currency_id)) }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
