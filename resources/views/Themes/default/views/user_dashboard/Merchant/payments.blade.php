                                        ...
                                        <tbody>
                                            @foreach($merchant_payments as $result)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ formatNumber($result->amount, optional($result->currency)->id)}}</td>

                                                    <td class="text-center">{{ (($result->charge_percentage + $result->charge_fixed) == 0) ? '-' : formatNumber($result->charge_percentage + $result->charge_fixed, optional($result->currency)->id) }}</td>

                                                    <td class="text-center">
                                                       <h4>{{ formatNumber($result->total, optional($result->currency)->id) }}</h4>
                                                    </td>

                                                    <td class="text-center">{{ optional($result->currency)->code}}</td>
