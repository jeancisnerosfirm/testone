            ...
            <div class="col-lg-6 col-xs-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>@lang('message.dashboard.exchange.left-top.title')</h3>
                    </div>
                        ...
                        <form accept-charset="utf-8" action="{{ url('exchange-of-money') }}" id="exchange1_form" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input class="form-control amount1" id="amount" name="amount" onkeypress="return isNumberOrDecimalPointKey(this, event);" placeholder="0.00" type="text"
                            ...
                            <div class="row mt-5">
                                <div class="col-md-12">
                                    ...
                                    <button class="btn btn-grad w-100" id="exchange-create" type="submit">
...
<script type="text/javascript">
    ...
    $(window).on('load', function()
    {
        ...
        determineDecimalPoint($('select#user-wallet').find(':selected').data('type'));
    });
    ...
    //Amount
    $(document).on('input', '.amount1', $.debounce(800, function (e)
    {
        var amount = $('.amount1').val().trim();
        if (amount.length === 0) {
            $('.amountLimit1').hide();
        ...
        getDepositFeesLimit($('select#user-wallet').find(':selected').data('type'));
    }));
