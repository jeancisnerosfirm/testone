	...
	<tr>
	  <td>
	   <table>
		  ...
		  <tr>
			<td style="font-size:15px; color:#4e5c6e; line-height:22px;">{{ optional($currencyExchange->fromWallet->currency)->code }}</td>
		  </tr>
		  <br><br>
		  ...
		  <tr>
			<td style="font-size:15px; color:#4e5c6e; line-height:22px;">{{ optional($currencyExchange->toWallet->currency)->code }}</td>
		  </tr>
		  <br><br>
		  ...
		  <tr>
			<td style="font-size:15px; color:#4e5c6e; line-height:22px;">1 {{ optional($currencyExchange->fromWallet->currency)->code }} = {{ formatNumber($currencyExchange->exchange_rate, optional($currencyExchange->toWallet->currency)->id) }} {{optional($currencyExchange->toWallet->currency)->code}}</td>
		  </tr>
		  </table>
	  </td>
	  </tr>
	  ...
	  <td>
	   <table style="margin-top:20px; width:300px;">
		  ...
		  <tr>
			...
			<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat(optional($currencyExchange->fromWallet->currency)->symbol, formatNumber($currencyExchange->amount, optional($currencyExchange->fromWallet->currency)->id)) }}</td>
		  </tr>

			@if ($currencyExchange->fee > 0)
				<tr style="padding-bottom:10px;">
					<td style="font-size:15px; color:#000000;">@lang('message.dashboard.left-table.fee')</td>
					<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat(optional($currencyExchange->fromWallet->currency)->symbol, formatNumber($currencyExchange->fee, optional($currencyExchange->fromWallet->currency)->id)) }}</td>
				</tr>
			@endif
		  ...
		  <tr>
			...
			<td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">{{ moneyFormat(optional($currencyExchange->fromWallet->currency)->symbol, formatNumber(($currencyExchange->amount + $currencyExchange->fee), optional($currencyExchange->fromWallet->currency)->id)) }}</td>
		  </tr>
		  </table>
	    </td>
	  </tr>
