			...
			<div class="col-lg-6 col-xs-12 mb20 marginTopPlus">
				<div class="card">
					...
					<div class="card-body">
						...
						<h5 class="text-center mt10">@lang('message.dashboard.send-request.send.confirmation.transfer-amount') : {{  moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['amount'], $transInfo['currency_id'])) }}</h5>
						<div class="mt-5">
							<div class="text-center">
