						...
						<table>
							...
							<tr>
								<td style="font-size:15px; color:#4e5c6e; line-height:22px;">
									{{ optional($transactionDetails->end_user)->first_name }}&nbsp;{{ optional($transactionDetails->end_user)->last_name}}
					...
					<td>
						<table style="margin-top:20px; width:300px;">
							...
							<tr>
								...
								<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat(optional($transactionDetails->currency)->symbol, formatNumber($transactionDetails->subtotal, $transactionDetails->currency_id)) }}</td>
							</tr>
							...
							@if (abs($transactionDetails->total) - abs($transactionDetails->subtotal) > 0)
								<tr style="padding-bottom:10px;">
									...
									<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat(optional($transactionDetails->currency)->symbol, formatNumber($transactionDetails->charge_percentage+$transactionDetails->charge_fixed, $transactionDetails->currency_id)) }}</td>
								</tr>
							@endif
							...
							<tr>
								...
								<td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">
									{{ moneyFormat(optional($transactionDetails->currency)->symbol, str_replace("-",'', formatNumber($transactionDetails->total, $transactionDetails->currency_id))) }}
								</td>
							</tr>
						</table>
					</td>
						...
						<table style="margin-top:20px; width:300px;">
							...
							<tr>
								...
								<td style="font-size:15px; color:#4e5c6e; text-align:right;">
									{{ moneyFormat(optional($transactionDetails->currency)->symbol, formatNumber($transactionDetails->subtotal, $transactionDetails->currency_id)) }}
								</td>
							</tr>
							<tr>
								<td colspan="2" style="border-top:1px solid #eaeaea; padding-top:0; margin-bottom:3px;"></td>
							...
							<tr>
								<td style="font-size:15px; color:#000000; font-weight:bold;">@lang('message.dashboard.left-table.total')</td>
								<td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">
									{{ moneyFormat(optional($transactionDetails->currency)->symbol, (str_replace("-",'', formatNumber($transactionDetails->subtotal, $transactionDetails->currency_id)))) }}
								</td>
							</tr>
						</table>
					</td>
