            ...
            <div class="col-lg-6 col-xs-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-center mt10">@lang('message.dashboard.deposit.deposit-amount') : {{  moneyFormat(optional($transaction->currency)->symbol, formatNumber($transaction->subtotal, $transaction->currency_id)) }}</h5>
