                ...
                <form id="depositForm1" action="{{ url('deposit') }}" method="post" accept-charset='UTF-8'>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-grad col-12 transfer_form" id="deposit-money">
                                        <i class="spinner fa fa-spinner fa-spin" style="display: none;"></i>
                                        <span id="deposit-money-text">@lang('message.dashboard.button.next')</span>
                                    </button>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(window).on('load',function()
    {
        ...
        if (confirmationUrl == previousUrl) {
            ...
            determineDecimalPoint($('select#currencies').find(':selected').data('type'));
            setTimeout(function()
            {
                removeDepositLocalStorageValues();
            }, 1300);
