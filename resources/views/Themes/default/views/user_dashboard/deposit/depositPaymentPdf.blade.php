...
<body>
   <div style="width:900px; margin:auto; top:20px; position:relative;">
	 ...
	 @php
		$methodName = optional($transactionDetails->payment_method)->name
	 @endphp
      <table>
	    <tr>
		  <td>
		   <table>
			  ...
			  <tr>
				<td style="font-size:15px; color:#4e5c6e; line-height:22px;">{{ $methodName == "Mts" ? "Pay Money" : $methodName }}</td>
			  </tr>
			  ...
			  <tr>
				<td style="font-size:15px; color:#4e5c6e; line-height:22px;">{{ isset($transactionDetails->currency) && !empty($transactionDetails->currency) ? optional($transactionDetails->currency)->code: ''}}</td>
			  </tr>
			  <br><br>
			  </table>
		  </td>
		  ...
		  <td>
		   <table style="margin-top:20px; width:300px;">
			  ...
			  <tr>
				...
				<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat(optional($transactionDetails->currency)->symbol, formatNumber($transactionDetails->total, $transactionDetails->currency_id)) }}</td>
			  </tr>
			  </table>
		    </td>
		  </tr>
