            ...
            <div class="col-lg-6 col-xs-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-center mt10">@lang('message.dashboard.send-request.request.success.accept-amount') : {{  moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['amount'], $transInfo['currency_id'])) }}</h5>
