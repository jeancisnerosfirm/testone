						...
						<table>
							...
							<tr>
								<td style="font-size:15px; color:#4e5c6e; line-height:22px;">
									{{ $transactionDetails->user_type == 'registered' ? optional($transactionDetails->end_user)->first_name.' '.optional($transactionDetails->end_user)->last_name : $transactionDetails->email }}
								</td>
							</tr>
							<br><br>
							<tr>
							...
							<tr>
								<td style="font-size:15px; color:#4e5c6e; line-height:22px;">{{ optional($transactionDetails->currency)->code }}</td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table style="margin-top:20px; width:300px;">
							...
							<tr>
								...
								<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat($transactionDetails->currency->symbol, formatNumber($transactionDetails->subtotal, optional($transactionDetails->currency)->id)) }}</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">
									{{ moneyFormat($transactionDetails->currency->symbol, (str_replace("-",'', formatNumber($transactionDetails->total, optional($transactionDetails->currency)->id))) ) }}
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td>
						<table style="margin-top:20px; width:300px;">
							...
							<tr>
								<td style="font-size:15px; color:#000000;">@lang('message.dashboard.send-request.request.confirmation.requested-amount')</td>
								<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat(optional($transactionDetails->currency)->symbol, formatNumber($transactionDetails->subtotal, optional($transactionDetails->currency)->id)) }}</td>
							</tr>
							...
							@if (abs($transactionDetails->total) - abs($transactionDetails->subtotal) > 0)
								<tr style="padding-bottom:10px;">
									...
									<td style="font-size:15px; color:#4e5c6e; text-align:right;">
										{{ moneyFormat($transactionDetails->currency->symbol, formatNumber($transactionDetails->charge_percentage + $transactionDetails->charge_fixed, optional($transactionDetails->currency)->id)) }}
									</td>
								</tr>
							@endif
							...
							<tr>
								<td style="font-size:15px; color:#000000; font-weight:bold;">@lang('message.dashboard.left-table.total')</td>
								<td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">
									{{ moneyFormat(optional($transactionDetails->currency)->symbol, str_replace("-",'', formatNumber($transactionDetails->total, optional($transactionDetails->currency)->id))) }}
								</td>
							</tr>
						</table>
					</td>
