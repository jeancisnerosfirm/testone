					...
					<div class="card-body">
						...
						<div class="row mt20">
							<div class="col-md-12">
								...
								<div class="pull-right"><strong>{{  moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['amount'], $transInfo['currency_id'])) }}</strong></div>
							</div>
						</div>
						...
						<div class="row mt10">
							<div class="col-md-12">
								...
								<div class="pull-right"><strong>{{  moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['fee'], $transInfo['currency_id'])) }}</strong></div>
							</div>
						</div>
						<hr />
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="pull-right"><strong>{{  moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['totalAmount'], $transInfo['currency_id'])) }}</strong></div>
							</div>
						</div>
