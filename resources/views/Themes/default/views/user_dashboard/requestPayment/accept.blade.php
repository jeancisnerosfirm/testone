            					...
            					<div class="row">
            						...
            						<div class="col-md-6">
            							<div class="form-group">
            								...
            								<input class="form-control" name="currency" data-rel="{{$requestPayment->currency->id}}" id="currency" type="text" value="{{$requestPayment->currency->code}}" data-type="{{ $requestPayment->currency->type }}" data-rel="{{$requestPayment->currency->id}}" readonly>
