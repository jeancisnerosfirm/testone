                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="pr-3 mt-2">
                                    <select class="form-control w-200p" id="type" name="type">
                                        ...
                                        <option value="crypto_exchange" <?= ($type == 'crypto_exchange') ? 'selected' : '' ?>>
                                            {{ __('Crypto Exchange') }}
                                        </option>
                                        <option value="crypto_buy" <?= ($type == 'crypto_buy') ? 'selected' : '' ?>>
                                            {{ __('Crypto Buy') }}
                                        </option> 
                                        <option value="crypto_sell" <?= ($type == 'crypto_sell') ? 'selected' : '' ?>>
                                            {{ __('Crypto Sell') }}
                                        </option> 
                                        @endif
