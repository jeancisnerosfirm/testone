                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <label class="upload-file" for="file">
                                                        <div class="upload-text border rounded p-1">
                                                            <i class="fa fa-cloud text-active" aria-hidden="true"></i>
                                                            <span class="p-1">{{ __('Choose a file') }}</span>
                                                        </div>
                                                    </label>
                                                    <p id="file-chosen"></p>
                                                </div>
                                    ...
                                    <div class="px-4">
                                        ...
                                        <div class="pl-5 mt-3 ml-2">
                                            <p>{!! $result->message !!}</p>
                                                @if($result->file)
                                                    <div class="mt-3">
                                                        <a class="text-info rounded-lg p-1 bg-light" href="{{ url('public/uploads/ticketFile/' . $result->file->filename) }}"><i class="fa fa-download text-active"></i> {{ $result->file->originalname }}</a>
                                                    </div>
                                                @endif
                                        </div>
                                    </div>
                                ...
                                @else
                                    ...
                                    <div class="px-4">
                                        ...
                                        <div class="pl-5 mt-3 ml-2">
                                            ...
                                            @if($result->file)
                                                <div class="mt-3">
                                                    <a class="text-info rounded-lg p-1 bg-light" href="{{ url('public/uploads/ticketFile/' . $result->file->filename) }}"><i class="fa fa-download text-active"></i> {{ $result->file->originalname }}
                                                    </a>
                                                </div>
                                            @endif
                                        </div>
